...
export default function Navbar() {
  ...
  return (
    <div className="flex flex-row  space-x-3 w-full h-[78px] bg-[#1832B8] font-sans shadow-[0px_1px_2px_0px_rgba(112,112,112,0.06),0px_1px_3px_0px_rgba(112,112,112,0.10)]">
      <div className="flex justify-between items-center h-full w-full px-4">
        <div className="flex items-center flex-1">
          <Image
            ...
            height={61}
          />
          <div className="flex flex-row space-x-4 font-sans ml-4 justify-center">
        ...
        <div className="flex flex-row items-center space-x-4 flex-1 justify-end">
          ...
          {authenticated ? (
            <div className="flex items-center justify-evenly rounded-[9999px] bg-[#AEFE03] text-black w-[189.78px] px-[24.108px] py-[11px] space-x-0.5" onClick={handleLogout}>
